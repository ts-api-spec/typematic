...
>(api: Api, endpoint: Endpoint, pathParam: PathParam, value: unknown) {
...
>(api: Api, method: Method, path: Path, pathParam: PathParam, value: unknown) {
...
>(api: Api, endpoint: Endpoint, queryParam: QueryParam, value: unknown) {
...
>(api: Api, method: Method, path: Path, queryParam: QueryParam, value: unknown) {
...
>(api: Api, endpoint: Endpoint, headerParam: HeaderParam, value: unknown) {
...
>(api: Api, method: Method, path: Path, headerParam: HeaderParam, value: unknown) {
...
>(api: Api, endpoint: Endpoint, cookieParam: CookieParam, value: unknown) {
...
>(api: Api, method: Method, path: Path, cookieParam: CookieParam, value: unknown) {
...
>(api: Api, endpoint: Endpoint, statusCode: StatusCode, value: unknown) {
...
>(api: Api, method: Method, path: Path, statusCode: StatusCode, value: unknown) {
